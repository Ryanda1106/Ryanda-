...
var xxx=null;
if(x=="1"){xxx="cara-agar-postingan-blog-cepat.html"}
if(x=="2"){xxx="inilah-7-widget-yang-wajib-ada-di-blog.html"}
if(x=="3"){xxx="2-Cara-Mengetahui-Postingan-Blog-Yang-Belum-Terindeks-Google.html"}
if(x=="4"){xxx="cara-cara-menentukan-target-kata-kunci.html"}
a_to_ve[i].href="https://codexlink.blogspot.com/2020/03/"+xxx+"?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
